            ...
            <aside id="cta-button-sidebar" className="h-full w-2/5 hidden transition-transform pl-5 lg:block" aria-label="Sidebar" aria-hidden="true">
                <div className="shadow-lg h-full px-3 py-4 border-2 dark:bg-gray-700">
                    ...
                    <ul className="space-y-2 font-medium mb-3">
                        <li className="flex justify-center items-center font-bold p-2 text-gray-900 rounded-lg dark:text-white">
                            <h5>SNS</h5>
                        </li>
                        <div className='flex justify-center'>
                            <Link href="https://github.com/hukuryo" className='mr-5 ease-in-out duration-300 hover:scale-110'>
                            ...
                            <Link href="https://twitter.com/hukuryo_" className="ease-in-out duration-300 hover:scale-110">
